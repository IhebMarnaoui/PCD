...
import { Form, Button, Col, Container, Navbar, Nav } from "react-bootstrap";
...
function SignUp() {
  ...
  const handleSubmit = (event) => {
   ...
   if (validated){
    ...
    axios
    .post("http://127.0.0.1:5000/adduser", data)
  ...
  return (
    <>
      ...
      <Container>
        <Form noValidate validated={validated} onSubmit={handleSubmit} style={{paddingTop:"50px", paddingBottom:"50px"}}>
          ...
          <Form.Row>
            ...
            <Form.Group as={Col} controlId="formGridCountry">
              ...
              <Form.Control required placeholder="Choose. . ." as="select" >
